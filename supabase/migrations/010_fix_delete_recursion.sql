...
-- Ejecutar en el SQL Editor de Supabase para arreglar el Error 500 al eliminar transacciones (infinite recursion)

BEGIN;

-- ==========================================
-- 1. ASEGURAR QUE LAS FUNCIONES HELPER (SECURITY DEFINER) EXISTEN Y SON SEGURAS
-- ==========================================
...
-- ==========================================
-- 2. REESCRIBIR POLÍTICAS DE TRANSACTIONS PARA EVITAR RECURSIÓN
-- ==========================================
...
-- ==========================================
-- 3. REESCRIBIR POLÍTICAS DE ACCOUNTS PARA EVITAR RECURSIÓN
-- ==========================================
